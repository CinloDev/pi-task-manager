...
(function (global) {
  ...
  function renderHelp(state, doc, validation) {
    ...
    var helpHtml = ''
      ...
      + '<li><code style=\"background:#1c222b;padding:2px 6px;border-radius:4px;color:#fff;\">/task-manager</code> (atajos <kbd style=\"background:#1c222b;padding:1px 5px;border-radius:3px;font-family:var(--font-mono);\">alt+t</kbd> / <kbd style=\"background:#1c222b;padding:1px 5px;border-radius:3px;font-family:var(--font-mono);\">ctrl+shift+t</kbd>): Abre el modal flotante en la terminal.</li>'
