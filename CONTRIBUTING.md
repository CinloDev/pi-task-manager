...
4. **Experiencia TUI en Terminal Completa**:
   - Todo el flujo del menú interactivo (`alt+j` / `ctrl+shift+j`) debe ocurrir dentro del componente flotante `TaskManagerModalOverlay`, sin expulsar al usuario a inputs secundarios ni cerrar la ventana inesperadamente.
